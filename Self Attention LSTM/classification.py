...
def visualize_attention(wts,x_test_pad,word_to_id,filename,filename2):
...
MAXLENGTH = model_params['timesteps'] #300
...
if classification_type == 'multiclass':
    train_loader,train_set,test_set,x_train_pad,x_test_pad,word_to_id = load_data_set(1,MAXLENGTH,model_params["vocab_size"],model_params['batch_size']) #load the reuters dataset
